      ...
      <Fade in={open}>
        ...
        >
          ...
          <input
            ...
            className="rounded-md p-4 outline-none w-80 bg-zinc-900 border border-gray-600 placeholder-gray-600 text-white"
          />
          <input
            onChange={onEmailChange}
            type="text"
            placeholder="Email for offline notifications"
            className="rounded-md p-4 outline-none w-80 bg-zinc-900 border border-gray-600 placeholder-gray-600 text-white"
          />
          <button
            onClick={() => onSave(username, email)}
            className="m-auto p-4 w-40 font-noto rounded-md hover:bg-blue-800 transition-colors text-center bg-blue-700 text-white"
          >
            Save
          </button>
        </div>
