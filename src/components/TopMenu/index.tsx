            ...
            {window.screen.width >= 1440 && (
                <>
                    <div className='relative'>
                        ...
                        <img onClick={handleMsgsClick} src='https://sticnuru.sirv.com/sol-hub-imgs/email.png' className={menuButtonStyle} alt='messages' />
                    </div>
                    <img onClick={props.onSettingsOpen} src='https://sticnuru.sirv.com/sol-hub-imgs/account.png' className={menuButtonStyle} alt='messages' />
                </>
            )}
